...
INSTALLED_APPS = [
    ...
    'django.contrib.humanize',  # For thousand separators (intcomma filter)
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME'),  # Use DB_NAME from .env file
...
# to avoid issues with missing source map files (.map files)
STORAGES = {
    "staticfiles": {
